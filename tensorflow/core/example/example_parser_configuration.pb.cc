...
class ExampleParserConfiguration_FeatureMapEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ExampleParserConfiguration::ExampleParserConfiguration_FeatureMapEntry> {
...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_FeatureConfiguration_default_instance_), fixed_len_feature_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_FeatureConfiguration_default_instance_), var_len_feature_),
...
file_level_metadata[3].reflection = ExampleParserConfiguration::ExampleParserConfiguration_FeatureMapEntry::CreateReflection(file_level_metadata[3].descriptor, _ExampleParserConfiguration_FeatureMapEntry_default_instance_.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _ExampleParserConfiguration_FeatureMapEntry_default_instance_.DefaultConstruct();
  ...
  _ExampleParserConfiguration_FeatureMapEntry_default_instance_.get_mutable()->set_default_instance(_ExampleParserConfiguration_FeatureMapEntry_default_instance_.get_mutable());
  _ExampleParserConfiguration_FeatureMapEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
}
