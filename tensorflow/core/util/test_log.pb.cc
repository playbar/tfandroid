...
class BenchmarkEntry_ExtrasEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<BenchmarkEntry::BenchmarkEntry_ExtrasEntry> {
...
class CPUInfo_CacheSizeEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<CPUInfo::CPUInfo_CacheSizeEntry> {
...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_EntryValue_default_instance_), double_value_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_EntryValue_default_instance_), string_value_),
  ...
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_CommitId_default_instance_), changelist_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_CommitId_default_instance_), hash_),
...
file_level_metadata[1].reflection = BenchmarkEntry::BenchmarkEntry_ExtrasEntry::CreateReflection(file_level_metadata[1].descriptor, _BenchmarkEntry_ExtrasEntry_default_instance_.get_mutable());
file_level_metadata[6].reflection = CPUInfo::CPUInfo_CacheSizeEntry::CreateReflection(file_level_metadata[6].descriptor, _CPUInfo_CacheSizeEntry_default_instance_.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _BenchmarkEntry_ExtrasEntry_default_instance_.DefaultConstruct();
  ...
  _CPUInfo_CacheSizeEntry_default_instance_.DefaultConstruct();
  ...
  _BenchmarkEntry_ExtrasEntry_default_instance_.get_mutable()->set_default_instance(_BenchmarkEntry_ExtrasEntry_default_instance_.get_mutable());
  _BenchmarkEntry_ExtrasEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
  _CommitId_default_instance_.changelist_ = GOOGLE_LONGLONG(0);
  _CommitId_default_instance_.hash_.UnsafeSetDefault(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited());
  _CPUInfo_CacheSizeEntry_default_instance_.get_mutable()->set_default_instance(_CPUInfo_CacheSizeEntry_default_instance_.get_mutable());
  _CPUInfo_CacheSizeEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
...
::google::protobuf::uint8* MachineConfiguration::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->device_info_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        4, this->device_info(i), deterministic, target);
  }
  ...
  for (unsigned int i = 0, n = this->available_device_info_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        5, this->available_device_info(i), deterministic, target);
  }
