...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "maryMetadata\022;\n\013plugin_data\030\001 \003(\0132&.tens"
...
SummaryMetadata::SummaryMetadata(const SummaryMetadata& from)
  : ::google::protobuf::Message(),
      _internal_metadata_(NULL),
      plugin_data_(from.plugin_data_),
      _cached_size_(0) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
...
void SummaryMetadata::SerializeWithCachedSizes(
  ...
  // repeated .tensorflow.SummaryMetadata.PluginData plugin_data = 1;
  for (unsigned int i = 0, n = this->plugin_data_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->plugin_data(i), output);
  }
  ...
  for (unsigned int i = 0, n = this->plugin_data_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        1, this->plugin_data(i), deterministic, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:tensorflow.SummaryMetadata)
  ...
  // repeated .tensorflow.SummaryMetadata.PluginData plugin_data = 1;
  {
    unsigned int count = this->plugin_data_size();
...
// @@protoc_insertion_point(class_specific_merge_from_start:tensorflow.SummaryMetadata)
  ...
  plugin_data_.MergeFrom(from.plugin_data_);
  if (from.display_name().size() > 0) {
...
void SummaryMetadata::InternalSwap(SummaryMetadata* other) {
  plugin_data_.InternalSwap(&other->plugin_data_);
...
// repeated .tensorflow.SummaryMetadata.PluginData plugin_data = 1;
int SummaryMetadata::plugin_data_size() const {
  return plugin_data_.size();
}
void SummaryMetadata::clear_plugin_data() {
  plugin_data_.Clear();
}
const ::tensorflow::SummaryMetadata_PluginData& SummaryMetadata::plugin_data(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.SummaryMetadata.plugin_data)
  return plugin_data_.Get(index);
}
::tensorflow::SummaryMetadata_PluginData* SummaryMetadata::mutable_plugin_data(int index) {
  // @@protoc_insertion_point(field_mutable:tensorflow.SummaryMetadata.plugin_data)
  return plugin_data_.Mutable(index);
}
::tensorflow::SummaryMetadata_PluginData* SummaryMetadata::add_plugin_data() {
