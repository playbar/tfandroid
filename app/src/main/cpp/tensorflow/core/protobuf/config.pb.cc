...
class ConfigProto_DeviceCountEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ConfigProto::ConfigProto_DeviceCountEntry> {
...
void TableStruct::InitDefaultsImpl() {
  ...
  _ConfigProto_DeviceCountEntry_default_instance_.DefaultConstruct();
  ...
  _ConfigProto_DeviceCountEntry_default_instance_.get_mutable()->set_default_instance(_ConfigProto_DeviceCountEntry_default_instance_.get_mutable());
  _ConfigProto_DeviceCountEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
  ...
  _ConfigProto_default_instance_.get_mutable()->cluster_def_ = const_cast< ::tensorflow::ClusterDef*>(
...
void GraphOptions::SharedCtor() {
  ::memset(&optimizer_options_, 0, reinterpret_cast<char*>(&build_cost_model_after_) -
...
// @@protoc_insertion_point(message_clear_start:tensorflow.GraphOptions)
  ...
  rewrite_options_ = NULL;
  ::memset(&build_cost_model_, 0, reinterpret_cast<char*>(&build_cost_model_after_) -
    reinterpret_cast<char*>(&build_cost_model_) + sizeof(build_cost_model_after_));
}
...
;
  ...
  for (unsigned int i = 0, n = this->session_inter_op_thread_pool_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        12, this->session_inter_op_thread_pool(i), deterministic, target);
  }
...
::google::protobuf::uint8* RunMetadata::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->partition_graphs_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        3, this->partition_graphs(i), deterministic, target);
  }
