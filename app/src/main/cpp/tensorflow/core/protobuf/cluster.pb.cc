...
class JobDef_TasksEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<JobDef::JobDef_TasksEntry> {
...
file_level_metadata[0].reflection = JobDef::JobDef_TasksEntry::CreateReflection(file_level_metadata[0].descriptor, _JobDef_TasksEntry_default_instance_.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _JobDef_TasksEntry_default_instance_.DefaultConstruct();
  _JobDef_default_instance_.DefaultConstruct();
  _ClusterDef_default_instance_.DefaultConstruct();
  _JobDef_TasksEntry_default_instance_.get_mutable()->set_default_instance(_JobDef_TasksEntry_default_instance_.get_mutable());
  _JobDef_TasksEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
}
...
::google::protobuf::uint8* ClusterDef::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->job_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        1, this->job(i), deterministic, target);
  }
