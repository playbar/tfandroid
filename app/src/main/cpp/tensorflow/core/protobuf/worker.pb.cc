...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  ...
  { 23, -1, sizeof(RegisterGraphRequest)},
  { 33, -1, sizeof(RegisterGraphResponse)},
  { 39, -1, sizeof(DeregisterGraphRequest)},
  { 46, -1, sizeof(DeregisterGraphResponse)},
  { 51, -1, sizeof(CleanupAllRequest)},
  { 57, -1, sizeof(CleanupAllResponse)},
  { 62, -1, sizeof(ExecutorOpts)},
  { 70, -1, sizeof(RunGraphRequest)},
  { 83, -1, sizeof(RunGraphResponse)},
  { 92, -1, sizeof(CleanupGraphRequest)},
  { 98, -1, sizeof(CleanupGraphResponse)},
  { 103, -1, sizeof(RecvTensorRequest)},
  { 114, -1, sizeof(RecvTensorResponse)},
  { 123, -1, sizeof(LoggingRequest)},
  { 131, -1, sizeof(LabeledStepStats)},
  { 138, -1, sizeof(LoggingResponse)},
  { 144, -1, sizeof(TraceOpts)},
  { 155, -1, sizeof(TracingRequest)},
  { 161, -1, sizeof(TracingResponse)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _RegisterGraphRequest_default_instance_.get_mutable()->debug_options_ = const_cast< ::tensorflow::DebugOptions*>(
  ...
  for (unsigned int i = 0, n = this->device_attributes_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        1, this->device_attributes(i), deterministic, target);
  }
...
ExecutorOpts::ExecutorOpts(const ExecutorOpts& from)
  ...
  ::memcpy(&record_costs_, &from.record_costs_,
    reinterpret_cast<char*>(&record_partition_graphs_) -
...
::google::protobuf::uint8* RunGraphRequest::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->send_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        3, this->send(i), deterministic, target);
  }
...
::google::protobuf::uint8* RunGraphResponse::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->recv_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        1, this->recv(i), deterministic, target);
  }
  ...
  for (unsigned int i = 0, n = this->partition_graph_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        4, this->partition_graph(i), deterministic, target);
  }
...
::google::protobuf::uint8* LoggingResponse::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->step_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        1, this->step(i), deterministic, target);
  }
