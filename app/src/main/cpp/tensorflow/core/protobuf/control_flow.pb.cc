...
class ValuesDef_ExternalValuesEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<ValuesDef::ValuesDef_ExternalValuesEntry> {
...
file_level_metadata[0].reflection = ValuesDef::ValuesDef_ExternalValuesEntry::CreateReflection(file_level_metadata[0].descriptor, _ValuesDef_ExternalValuesEntry_default_instance_.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _ValuesDef_ExternalValuesEntry_default_instance_.DefaultConstruct();
  ...
  _ValuesDef_ExternalValuesEntry_default_instance_.get_mutable()->set_default_instance(_ValuesDef_ExternalValuesEntry_default_instance_.get_mutable());
  _ValuesDef_ExternalValuesEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
