...
class DeviceProperties_EnvironmentEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<DeviceProperties::DeviceProperties_EnvironmentEntry> {
} _DeviceProperties_EnvironmentEntry_default_instance_;
class DevicePropertiesDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<DeviceProperties> {
...
void TableStruct::Shutdown() {
  _DeviceProperties_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _DeviceProperties_EnvironmentEntry_default_instance_.DefaultConstruct();
  _DeviceProperties_default_instance_.DefaultConstruct();
  _DeviceProperties_EnvironmentEntry_default_instance_.get_mutable()->set_default_instance(_DeviceProperties_EnvironmentEntry_default_instance_.get_mutable());
