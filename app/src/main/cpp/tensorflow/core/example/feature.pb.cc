...
class Features_FeatureEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<Features::Features_FeatureEntry> {
...
class FeatureLists_FeatureListEntryDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<FeatureLists::FeatureLists_FeatureListEntry> {
...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_Feature_default_instance_), bytes_list_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_Feature_default_instance_), float_list_),
  GOOGLE_PROTOBUF_GENERATED_DEFAULT_ONEOF_FIELD_OFFSET((&_Feature_default_instance_), int64_list_),
...
file_level_metadata[4].reflection = Features::Features_FeatureEntry::CreateReflection(file_level_metadata[4].descriptor, _Features_FeatureEntry_default_instance_.get_mutable());
file_level_metadata[7].reflection = FeatureLists::FeatureLists_FeatureListEntry::CreateReflection(file_level_metadata[7].descriptor, _FeatureLists_FeatureListEntry_default_instance_.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Features_FeatureEntry_default_instance_.DefaultConstruct();
  _Features_default_instance_.DefaultConstruct();
  _FeatureList_default_instance_.DefaultConstruct();
  _FeatureLists_FeatureListEntry_default_instance_.DefaultConstruct();
  ...
  _Features_FeatureEntry_default_instance_.get_mutable()->set_default_instance(_Features_FeatureEntry_default_instance_.get_mutable());
  _Features_FeatureEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
  _FeatureLists_FeatureListEntry_default_instance_.get_mutable()->set_default_instance(_FeatureLists_FeatureListEntry_default_instance_.get_mutable());
  _FeatureLists_FeatureListEntry_default_instance_.get_mutable()->InitAsDefaultInstance();
}
