...
namespace protobuf_error_5fcodes_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "error_codes.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
const ::google::protobuf::EnumDescriptor* Code_descriptor() {
  protobuf_error_5fcodes_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_error_5fcodes_2eproto::file_level_enum_descriptors[0];
}
